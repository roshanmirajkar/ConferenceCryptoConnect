...
export class MemStorage implements IStorage {
  ...
  private seedData() {
    // Seed demo conference attendees (fictional for demo purposes)
    const sampleUsers = [
      {
        username: "alex_chen",
        ...
        company: "DeFi Labs",
        bio: "Building next-generation DeFi protocols",
        interests: ["DeFi", "Smart Contracts", "Security"],
      ...
      },
      {
        ...
        bio: "Making crypto accessible to everyone",
        interests: ["UX", "Product", "Trading"],
      ...
      },
      {
        ...
        interests: ["Development", "Web3", "Infrastructure"],
      ...
      },
      {
        ...
        company: "Audit Firm",
        bio: "Securing the future of decentralized finance",
        interests: ["Security", "Auditing", "Research"],
      ...
      },
      {
        ...
        company: "Crypto Fund",
        bio: "Analyzing emerging trends in the crypto ecosystem",
        interests: ["Investing", "Analysis", "Trends"],
